...
//********************************************//
//由于现实字符编码问题，所以以下中文字必须以ANSI标准格式显示
//"正在打印""操作""暂停"三个界面的标题栏只做"中英切换"。
...
void machine_setting_disp()
{
    ...
    machine_menu.GcodeConf=MACHINE_GCODE_EN;
	...
	switch(gCfgItems.language)
	{
	 ...
	 machine_menu.HotbedEnable=HOTBED_ENABLE_T_CN;
		...
		case LANG_GERMAN:
			...
			main_menu.autoleveling=AUTO_LEVELING_TEXT_GE;
			main_menu.fan = FAN_TEXT_GE;
			main_menu.set=SET_TEXT_GE;
			main_menu.more=MORE_TEXT_GE;
			main_menu.tool = TOOL_TEXT_GE;
			//TOOL
			tool_menu.title = TOOL_TEXT_GE;
			tool_menu.preheat = TOOL_PREHEAT_GE;
			tool_menu.extrude = TOOL_EXTRUDE_GE;
			tool_menu.move = TOOL_MOVE_GE;
			tool_menu.home= TOOL_HOME_GE;
			tool_menu.leveling = TOOL_LEVELING_GE;
            		tool_menu.autoleveling = TOOL_AUTO_LEVELING_GE;
			tool_menu.filament = TOOL_FILAMENT_GE;
			tool_menu.more = TOOL_MORE_GE;			
			//预热
			...
			file_menu.no_file_and_check = NO_FILE_GE;//NO_FILE_AND_CHECK_GE;			
			//挤出
			...
			set_menu.filesys=FILESYS_TEXT_GE;
			set_menu.wifi=WIFI_TEXT_GE;
			...
			set_menu.language=LANGUAGE_TEXT_GE;
            		set_menu.machine_para = MACHINE_PARA_GE;
			//更多
			more_menu.title = TITLE_MORE_GE;
			more_menu.zoffset = ZOFFSET_GE;
			//文件系统
			filesys_menu.title = TITLE_FILESYS_GE;
			filesys_menu.sd_sys = SD_CARD_TEXT_GE;
			filesys_menu.usb_sys = U_DISK_TEXT_GE;
			//WIFI
			wifi_menu.title=WIFI_TEXT;
			//wifi_menu.key = WIFI_KEY_TEXT_GE;
			//wifi_menu.ip = WIFI_IP_TEXT_GE;
			//wifi_menu.state= WIFI_STA_TEXT_GE;
			wifi_menu.cloud= CLOUD_TEXT_GE;
			wifi_menu.reconnect = WIFI_RECONNECT_TEXT_GE;

			cloud_menu.title = TITLE_CLOUD_TEXT_GE;
			cloud_menu.bind = CLOUD_BINDED_GE;
			cloud_menu.binded = CLOUD_BINDED_GE;
			cloud_menu.unbind = CLOUD_UNBIND_GE;
			cloud_menu.unbinding = CLOUD_UNBINDED_GE;
			cloud_menu.disconnected = CLOUD_DISCONNECTED_GE;
			cloud_menu.disable = CLOUD_DISABLE_GE;
			//关于
			about_menu.title = TITLE_ABOUT_GE;
			about_menu.type = ABOUT_TYPE_TEXT_GE;
			about_menu.version = ABOUT_VERSION_TEXT_GE;
			about_menu.wifi = ABOUT_WIFI_TEXT_GE;			
			//风扇
			fan_menu.title = TITLE_FAN_GE;
			...
			language_menu.next = PAGE_DOWN_TEXT_GE;
			language_menu.up = PAGE_UP_TEXT_GE;			
			//正在打印界面
			...
			operation_menu.more = PRINTING_MORE_GE;
			operation_menu.move = PRINTING_MOVE_GE;
			operation_menu.auto_off = AUTO_SHUTDOWN_GE;
			operation_menu.manual_off = MANUAL_SHUTDOWN_GE;			
			//暂停界面
			pause_menu.title= TITLE_PAUSE_GE;
			pause_menu.resume = PRINTING_RESUME_GE;
			pause_menu.stop = PRINTING_STOP_GE;
			pause_menu.extrude = PRINTING_EXTRUDER_GE;
			pause_menu.move = PRINTING_MOVE_GE;
			pause_menu.filament = FILAMENT_TEXT_GE;
			pause_menu.more = PRINTING_MORE_GE;

			//变速界面
			speed_menu.title = TITLE_CHANGESPEED_GE;
			...
			//打印中---更多界面
			printing_more_menu.title = TITLE_MORE_GE;
			printing_more_menu.fan = FAN_TEXT_GE;
			printing_more_menu.auto_close = AUTO_SHUTDOWN_GE;
			printing_more_menu.manual = MANUAL_SHUTDOWN_GE;
			printing_more_menu.speed = PRINTING_CHANGESPEED_GE;
			printing_more_menu.temp = PRINTING_TEMP_GE;

			//print_file_dialog_menu.title = TITLE_DIALOG_CONFIRM_GE;
			...
			//ZOFFSET
			zoffset_menu.title = TITLE_ZOFFSET_GE;
			zoffset_menu.inc = ZOFFSET_INC_GE;
			zoffset_menu.dec = ZOFFSET_DEC_GE;				
			break;
			#if 0
		case LANG_JAPAN:
			common_menu.dialog_confirm_title = TITLE_DIALOG_CONFIRM_EN;
			common_menu.text_back=BACK_TEXT_JP;
			common_menu.close_machine_tips = DIALOG_CLOSE_MACHINE_EN;
			common_menu.unbind_printer_tips = DIALOG_UNBIND_PRINTER_EN;
			common_menu.print_special_title = PRINTING_OTHER_LANGUGE;
			common_menu.pause_special_title = PRINTING_PAUSE_OTHER_LANGUGE;
			common_menu.operate_special_title = PRINTING_OPERATION_OTHER_LANGUGE;			
			//主页面
			main_menu.title=TITLE_READYPRINT_JP;
			main_menu.preheat=PREHEAT_TEXT_JP;
			main_menu.move=MOVE_TEXT_JP;
			main_menu.home=HOME_TEXT_JP;
			main_menu.print=PRINT_TEXT_JP;
			main_menu.extrude=EXTRUDE_TEXT_JP;
			main_menu.leveling=LEVELING_TEXT_JP;
			main_menu.autoleveling=AUTO_LEVELING_TEXT_JP;
			main_menu.fan = FAN_TEXT_JP;
			main_menu.set=SET_TEXT_JP;
			main_menu.more=MORE_TEXT_JP;
			main_menu.tool = TOOL_TEXT_JP;
			//TOOL
			tool_menu.title = TOOL_TEXT_JP;
			tool_menu.preheat = TOOL_PREHEAT_JP;
			tool_menu.extrude = TOOL_EXTRUDE_JP;
			tool_menu.move = TOOL_MOVE_JP;
			tool_menu.home= TOOL_HOME_JP;
			tool_menu.leveling = TOOL_LEVELING_JP;
            		tool_menu.autoleveling = TOOL_AUTO_LEVELING_JP;
			tool_menu.filament = TOOL_FILAMENT_JP;
			tool_menu.more = TOOL_MORE_JP;			
			//预热
			preheat_menu.adjust_title = TITLE_ADJUST_JP;
			preheat_menu.title=TITLE_PREHEAT_JP;
			preheat_menu.add=ADD_TEXT_JP;
			preheat_menu.dec=DEC_TEXT_JP;
			preheat_menu.ext1=EXTRUDER_1_TEXT_JP;
			preheat_menu.ext2=EXTRUDER_2_TEXT_JP;
			preheat_menu.hotbed=HEATBED_TEXT_JP;
			preheat_menu.off=CLOSE_TEXT_JP;
			//移动
			move_menu.title = TITLE_MOVE_JP;
			//归零
			home_menu.title=TITLE_HOME_JP;
			home_menu.stopmove = HOME_STOPMOVE_JP;
			//文件目录
			file_menu.title=TITLE_CHOOSEFILE_JP;
			file_menu.page_up=PAGE_UP_TEXT_JP;
			file_menu.page_down=PAGE_DOWN_TEXT_JP;
			file_menu.file_loading = FILE_LOADING_JP;
			file_menu.no_file = NO_FILE_JP;
			file_menu.no_file_and_check = NO_FILE_JP;//NO_FILE_AND_CHECK_JP;			
			//挤出
			extrude_menu.title=TITLE_EXTRUDE_JP;
			extrude_menu.in=EXTRUDER_IN_TEXT_JP;
			extrude_menu.out=EXTRUDER_OUT_TEXT_JP;
			extrude_menu.ext1=EXTRUDER_1_TEXT_JP;
			extrude_menu.ext2=EXTRUDER_2_TEXT_JP;
			extrude_menu.low=EXTRUDE_LOW_SPEED_TEXT_JP;
			extrude_menu.normal=EXTRUDE_MEDIUM_SPEED_TEXT_JP;
			extrude_menu.high=EXTRUDE_HIGH_SPEED_TEXT_JP;
			extrude_menu.temper_text=EXTRUDER_TEMP_TEXT_JP;
			//调平
			leveling_menu.title=TITLE_LEVELING_JP;
			leveling_menu.position1=LEVELING_POINT1_TEXT_JP;
			leveling_menu.position2=LEVELING_POINT2_TEXT_JP;
			leveling_menu.position3=LEVELING_POINT3_TEXT_JP;
			leveling_menu.position4=LEVELING_POINT4_TEXT_JP;
			leveling_menu.position5=LEVELING_POINT5_TEXT_JP;
			//设置
			set_menu.title=TITLE_SET_JP;
			set_menu.filesys=FILESYS_TEXT_JP;
			set_menu.wifi=WIFI_TEXT_JP;
			set_menu.about=ABOUT_TEXT_JP;
			set_menu.fan=FAN_TEXT_JP;
			set_menu.filament=FILAMENT_TEXT_JP;
			set_menu.breakpoint=BREAK_POINT_TEXT_JP;
			set_menu.motoroff=MOTOR_OFF_TEXT_JP;
			set_menu.language=LANGUAGE_TEXT_JP;
            		set_menu.machine_para = MACHINE_PARA_JP;
			//更多
			more_menu.title = TITLE_MORE_JP;
			more_menu.zoffset = ZOFFSET_JP;
			//文件系统
			filesys_menu.title = TITLE_FILESYS_JP;
			filesys_menu.sd_sys = SD_CARD_TEXT_JP;
			filesys_menu.usb_sys = U_DISK_TEXT_JP;
			//WIFI
			wifi_menu.title=WIFI_TEXT;
			//wifi_menu.key = WIFI_KEY_TEXT_JP;
			//wifi_menu.ip = WIFI_IP_TEXT_JP;
			//wifi_menu.state= WIFI_STA_TEXT_JP;
			wifi_menu.cloud= CLOUD_TEXT_JP;
			wifi_menu.reconnect = WIFI_RECONNECT_TEXT_JP;

			cloud_menu.title = TITLE_CLOUD_TEXT_JP;
			cloud_menu.bind = CLOUD_BINDED_JP;
			cloud_menu.binded = CLOUD_BINDED_JP;
			cloud_menu.unbind = CLOUD_UNBIND_JP;
			cloud_menu.unbinding = CLOUD_UNBINDED_JP;
			cloud_menu.disconnected = CLOUD_DISCONNECTED_JP;
			cloud_menu.disable = CLOUD_DISABLE_JP;
			//关于
			about_menu.title = TITLE_ABOUT_JP;
			about_menu.type = ABOUT_TYPE_TEXT_JP;
			about_menu.version = ABOUT_VERSION_TEXT_JP;
			about_menu.wifi = ABOUT_WIFI_TEXT_JP;			
			//风扇
			fan_menu.title = TITLE_FAN_JP;
			fan_menu.add = FAN_ADD_TEXT_JP;
			fan_menu.dec = FAN_DEC_TEXT_JP;
			fan_menu.state = FAN_TIPS1_TEXT_JP;
			//换料
			filament_menu.title = TITLE_FILAMENT_JP;
			filament_menu.in = FILAMENT_IN_TEXT_JP;
			filament_menu.out = FILAMENT_OUT_TEXT_JP;
			filament_menu.ext1 = FILAMENT_EXT0_TEXT_JP;
			filament_menu.ext2 = FILAMENT_EXT1_TEXT_JP;
			filament_menu.ready_replace = FILAMENT_CHANGE_TEXT_JP;
			filament_menu.filament_dialog_load_heat = FILAMENT_DIALOG_LOAD_HEAT_TIPS_JP;
			filament_menu.filament_dialog_load_heat_confirm = FILAMENT_DIALOG_LOAD_CONFIRM1_TIPS_JP;
			filament_menu.filament_dialog_loading = FILAMENT_DIALOG_LOADING_TIPS_JP;
			filament_menu.filament_dialog_load_completed = FILAMENT_DIALOG_LOAD_COMPLETE_TIPS_JP;
			filament_menu.filament_dialog_unload_heat = FILAMENT_DIALOG_UNLOAD_HEAT_TIPS_JP;
			filament_menu.filament_dialog_unload_heat_confirm = FILAMENT_DIALOG_UNLOAD_CONFIRM_TIPS_JP;
			filament_menu.filament_dialog_unloading = FILAMENT_DIALOG_UNLOADING_TIPS_JP;
			filament_menu.filament_dialog_unload_completed = FILAMENT_DIALOG_UNLOAD_COMPLETE_TIPS_JP;

			//语言
			language_menu.title = TITLE_LANGUAGE_JP;
			language_menu.next = PAGE_DOWN_TEXT_JP;
			language_menu.up = PAGE_UP_TEXT_JP;			
			//正在打印界面
			printing_menu.title = TITLE_PRINTING_JP;
			printing_menu.option = PRINTING_OPERATION_JP;
			printing_menu.stop = PRINTING_STOP_JP;
			printing_menu.pause = PRINTING_PAUSE_JP;
			printing_menu.resume = PRINTING_RESUME_JP;

			//操作界面
			operation_menu.title = TITLE_OPERATION_JP;
			operation_menu.pause = PRINTING_PAUSE_JP;
			operation_menu.stop = PRINTING_STOP_JP;
			operation_menu.temp = PRINTING_TEMP_JP;
			operation_menu.fan = FAN_TEXT_JP;
			operation_menu.extr = PRINTING_EXTRUDER_JP;
			operation_menu.speed = PRINTING_CHANGESPEED_JP;			
			operation_menu.filament= FILAMENT_TEXT_JP;
			operation_menu.more = PRINTING_MORE_JP;
			operation_menu.move = PRINTING_MOVE_JP;
			operation_menu.auto_off = AUTO_SHUTDOWN_JP;
			operation_menu.manual_off = MANUAL_SHUTDOWN_JP;			
			//暂停界面
			pause_menu.title= TITLE_PAUSE_JP;
			pause_menu.resume = PRINTING_RESUME_JP;
			pause_menu.stop = PRINTING_STOP_JP;
			pause_menu.extrude = PRINTING_EXTRUDER_JP;
			pause_menu.move = PRINTING_MOVE_JP;
			pause_menu.filament = FILAMENT_TEXT_JP;
			pause_menu.more = PRINTING_MORE_JP;

			//变速界面
			speed_menu.title = TITLE_CHANGESPEED_JP;
			speed_menu.add = ADD_TEXT_JP;
			speed_menu.dec = DEC_TEXT_JP;
			speed_menu.move = MOVE_SPEED_JP;
			speed_menu.extrude = EXTRUDER_SPEED_JP;
			speed_menu.extrude_speed = EXTRUDER_SPEED_STATE_JP;
			speed_menu.move_speed = MOVE_SPEED_STATE_JP;
			//打印中---更多界面
			printing_more_menu.title = TITLE_MORE_JP;
			printing_more_menu.fan = FAN_TEXT_JP;
			printing_more_menu.auto_close = AUTO_SHUTDOWN_JP;
			printing_more_menu.manual = MANUAL_SHUTDOWN_JP;
			printing_more_menu.speed = PRINTING_CHANGESPEED_JP;
			printing_more_menu.temp = PRINTING_TEMP_JP;

			//print_file_dialog_menu.title = TITLE_DIALOG_CONFIRM_JP;
			print_file_dialog_menu.confirm = DIALOG_CONFIRM_JP;
			print_file_dialog_menu.cancle = DIALOG_CANCLE_JP;
			print_file_dialog_menu.print_file = DIALOG_PRINT_MODEL_JP;
			print_file_dialog_menu.cancle_print = DIALOG_CANCEL_PRINT_JP;
			print_file_dialog_menu.retry = DIALOG_RETRY_JP;
			print_file_dialog_menu.stop = DIALOG_STOP_JP;
			print_file_dialog_menu.no_file_print_tips = DIALOG_ERROR_TIPS1_JP;	
			print_file_dialog_menu.print_from_breakpoint = DIALOG_REPRINT_FROM_BREAKPOINT_JP;
			print_file_dialog_menu.close_machine_error = DIALOG_ERROR_TIPS2_JP;
            		print_file_dialog_menu.filament_no_press=DIALOG_FILAMENT_NO_PRESS_JP;
			print_file_dialog_menu.print_finish=DIALOG_PRINT_FINISH_JP;
			print_file_dialog_menu.print_time=DIALOG_PRINT_TIME_JP;
			print_file_dialog_menu.reprint=DIALOG_REPRINT_JP;
			print_file_dialog_menu.wifi_enable_tips=DIALOG_WIFI_ENABLE_TIPS_JP;
			//ZOFFSET
			zoffset_menu.title = TITLE_ZOFFSET_EN;
			zoffset_menu.inc = ZOFFSET_INC_JP;
			zoffset_menu.dec = ZOFFSET_DEC_JP;				
			break;
			#endif
		default:
		//机器参数
