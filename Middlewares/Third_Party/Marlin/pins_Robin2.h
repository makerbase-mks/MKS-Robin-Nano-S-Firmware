...
#define TEMP_1_PIN         26   // ANALOG NUMBERING
...
//
#define SPINDLE_LASER_PWM_PIN     17 // 2  // MUST BE HARDWARE PWM
#define SPINDLE_LASER_ENABLE_PIN 27  // Pin should have a pullup!
#define SPINDLE_DIR_PIN          28
