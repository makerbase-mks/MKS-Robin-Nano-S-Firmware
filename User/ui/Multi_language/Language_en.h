...
#define PAUSE_POSITION_X_EN  "X axis position (Absolute position)"
#define PAUSE_POSITION_Y_EN  "Y axis position (Absolute position)"
#define PAUSE_POSITION_Z_EN  "Z axis position (Relative position)"
...
#define TEXT_WIFI_PASSWORD_EN "Content"
