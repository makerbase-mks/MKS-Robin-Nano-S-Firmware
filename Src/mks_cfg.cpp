...
//CUSTOMER CMD
	...
	eprBurnValue(">MACHINE_PARAMETER", &mksCfg.machine_parameter, EPR_MACHINE_PARAMETER);
...
//THERMAL_PROTECTION_BED_PERIOD
    ...
    AT24CXX_Read((uint16_t)EPR_MACHINE_PARAMETER,&mksCfg.machine_parameter,1);
