...
#define Lcd_SET()         PCout(6)=1
#define Lcd_RESET()       PCout(6)=0
...
typedef struct			
{
	volatile uint16_t para_04h[3];
	volatile uint16_t para_05h;
	volatile uint16_t para_09h[4];
	volatile uint16_t para_0Ah;
	volatile uint16_t para_0Bh;
	volatile uint16_t para_0Ch;
	volatile uint16_t para_0Dh;
	volatile uint16_t para_0Eh;
	volatile uint16_t para_0Fh;
	//volatile uint16_t para_45h[2];
	volatile uint16_t para_52h;
	volatile uint16_t para_54h;
	volatile uint16_t para_56h;
	volatile uint16_t para_5Fh;
	volatile uint16_t para_DAh;
	volatile uint16_t para_DBh;
	volatile uint16_t para_DCh;
}LCD_REG_VALUE;	

extern LCD_REG_VALUE lcd_reg_value;
