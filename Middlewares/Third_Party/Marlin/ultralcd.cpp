...
#if 1//ENABLED(AUTO_BED_LEVELING_UBL) || ENABLED(G26_MESH_VALIDATION)
...
void lcd_Init_Lite() 	/*--mks--*/
{
  ...
  void lcd_tune_menu() {
    ...
    //
        ...
        #endif
		MKS_FAN_TIM = fanSpeeds[0]*10000/255;	/*--mks--*/
      #endif
      #if HAS_FAN1
