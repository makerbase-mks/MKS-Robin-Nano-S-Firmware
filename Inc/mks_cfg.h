...
#define BAK_INF_VALID_FLAG			0x76313031//acsii --> V100
/*
16	1417
12	969
EEPROM 2K byte 分配
...
#define EPR_MACHINE_PARAMETER       EPR_Z_SAVE_HOMING + 1


#define EPR_END_ADDR			EPR_MACHINE_PARAMETER + 1
...
typedef struct
{
	...
	uint8_t 	z2_endstop; 			//0:Z与Z2同一个限位接口,
															//1:X最大限位接口，
															//2:X最小限位接口
	uint8_t   x_enable_on;
	uint8_t   y_enable_on;
