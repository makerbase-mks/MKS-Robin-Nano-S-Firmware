...
static BUTTON_STRUCT MachineArrow,StrokeArrow,HomeDirectionArrow,EndstopTypeArrow,FilamentArrow,LevelingArrow,GcodeArrow;
static BUTTON_STRUCT buttonMachine,buttonStroke,buttonHomeDirection,buttonEndstopType,buttonFilament,buttonLeveling,GcodeText;
...
static void cbMachineSettingsWin(WM_MESSAGE * pMsg) {
    ...
    switch (pMsg->MsgId)
    {
    	...
    	case WM_NOTIFY_PARENT:
			...
			else if((pMsg->hWinSrc == GcodeText.btnHandle)||
...
{   
    ...
    else
    {
	 ...
	 GcodeText.btnHandle = BUTTON_CreateEx(10,150,450,40,hMachineSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        GcodeArrow.btnHandle = BUTTON_CreateEx(460,150,10,40,hMachineSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
	 ...
	 BUTTON_SetBmpFileName(GcodeText.btnHandle,NULL,1);
	 ...
	 BUTTON_SetTextAlign(GcodeText.btnHandle,GUI_TA_LEFT|GUI_TA_VCENTER ); 
     ...
     if(gCfgItems.multiple_language != 0)
     {
        ...
        else
        {
	     ...
	     BUTTON_SetText(GcodeText.btnHandle, machine_menu.GcodeConf);
